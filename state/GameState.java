 ...
 // Add to GameState.java
    ...
    private DropItem.ItemCreator getItemCreatorFromString(String creatorRef) {
        ...
        switch (creatorRef) {
            ...
            case "ItemManager::createFruitDark":  
                return ItemManager::createFruitDark; 
            case "ItemManager::createFruitGrapes":  
                return ItemManager::createFruitGrapes; 
            case "ItemManager::createFruitLime":  
                return ItemManager::createFruitLime; 
            case "ItemManager::createFruitTomatoe":  
                return ItemManager::createFruitTomatoe;
            case "ItemManager::createFruitWaterMelon":  
                return ItemManager::createFruitWaterMelon; 
                
            case "ItemManager::createMpLargeBottle":  
                return ItemManager::createMpLargeBottle;    
            case "ItemManager::createMpMediumBottle":  
                return ItemManager::createMpMediumBottle;   
            case "ItemManager::createMpSmallVial":  
                return ItemManager::createMpSmallVial; 
            case "ItemManager::createHpSmallVial":  
                return ItemManager::createHpSmallVial;  
            case "ItemManager::createHpMediumBottle":  
                return ItemManager::createHpMediumBottle;    
            case "ItemManager::createHpLargeBottle":  
                return ItemManager::createHpLargeBottle; 
            case "ItemManager::createStaminaLargeBottle":  
                return ItemManager::createStaminaLargeBottle;  
            case "ItemManager::createStaminaMediumBottle":  
                return ItemManager::createStaminaMediumBottle;  
            case "ItemManager::createStaminaSmallVial":  
                return ItemManager::createStaminaSmallVial; 
            case "ItemManager::createCureSmallVial":  
                return ItemManager::createCureSmallVial;    
