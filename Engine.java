...
public class Engine extends Canvas implements Runnable, KeyListener {
    ...
    private void handleInput() {
    	...
    	// ★ NEW: Block all input during transition
        if (gameState.isInputBlocked()) {
            return;
        }
    ...
    public void keyPressed(KeyEvent e) { 
    	...
    	// ★ NEW: Block keyboard input during transition (except F3 debug)
        if (gameState != null && gameState.isInputBlocked()) {
            // Allow F3 debug toggle even during transition
