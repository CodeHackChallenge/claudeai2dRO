...
public class DropTable {
    ...
    private void initializeDrops() {
        ...
        uncommonItems.add(new DropItem("Essence", DropRarity.UNCOMMON, 1, 4, 
        ...
        rareItems.add(new DropItem("Lucky Pouch", DropRarity.RARE, 1, 2, 
            ItemManager::createLuckyPouch));
        
        itemsByRarity.put(DropRarity.RARE, rareItems);
        
        // Epic items - rare materials
        List<DropItem> epicItems = new ArrayList<>();
        epicItems.add(new DropItem("Scroll of Purity", DropRarity.EPIC, 1, 1, 
