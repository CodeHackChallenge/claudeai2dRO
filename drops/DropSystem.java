...
public class DropSystem {
    ...
    public List<DroppedItem> generateDrops(int maxDropCapacity, int monsterLevel, 
        ...
        if (zoneLootConfig != null && activeQuestId != null) {
        	System.out.println(" *******zoneLootConfig activeQuestId="+activeQuestId);
        ...
        //System.out.println(" *******isLuckyDrop beforel");
        if (isLuckyDrop) {
    ...
    private List<DroppedItem> generateRegularDrops(int numDrops, int monsterLevel) {
        ...
        //System.out.println(" *******generateRegularDrops numDrops="+numDrops);
        for (int i = 0; i < numDrops; i++) {
            ...
            if (availableItems.isEmpty()) {
            	//System.out.println(" *******generateRegularDrops availableItems.isEmpty()");
            ...
            if (selectedItems.contains(selectedItem)) {
            	//System.out.println(" *******generateRegularDrops selectedItems");
                i--;
                continue;
            }
            ...
            if (selectedItem.getMaxQuantity() > selectedItem.getMinQuantity()) {
            	//System.out.println(" *******generateRegularDrops selectedItem.getMaxQuantity()");
                
                quantity = random.nextInt(selectedItem.getMinQuantity(), selectedItem.getMaxQuantity());
               // System.out.println(" *******generateRegularDrops selectedItem.quantity");
            
            } else {
            	//System.out.println(" *******generateRegularDrops selectedItem.else()");
                
                quantity = selectedItem.getMinQuantity();
            }
            
            drops.add(new DroppedItem(selectedItem, quantity));
            //System.out.println(" *******generateRegularDrops drops.add()");
            
        }
        //System.out.println(" *******generateRegularDrops return DROPS");
        return drops;
    }
